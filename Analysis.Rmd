...
Although the AIC of the model without `Fare` is slighlty higher than the model with it, it is not significant enough for us to keep `Fare` in the model. Thus the third fit is what we will be going with.
